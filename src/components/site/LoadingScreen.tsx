...
export default function LoadingScreen({ fixed = false }: LoadingScreenProps) {
  return (
    <div
      className={`${fixed ? "fixed inset-0 z-9999" : "min-h-screen w-full"} bg-linear-to-b from-sky-50 via-blue-50 to-slate-100`}
      role="status"
      aria-live="polite"
      aria-busy="true"
    >
